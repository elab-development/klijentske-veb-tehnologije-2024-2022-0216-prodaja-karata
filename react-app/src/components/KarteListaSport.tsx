...
function KarteListaSport() {
  ...
  const fetchEvents = async () => {
    ...
    const url = `https://app.ticketmaster.com/discovery/v2/events.json?classificationName=sport&apikey=${apiKey}`;
...
export default KarteListaSport;